...
import com.zlf.serverauth.config.interceptor.AuthorizationInterceptor;
import com.zlf.serverauth.config.interceptor.ServerProtectInterceptor;
...
public class WebMvcConfig extends WebMvcConfigurationSupport {
    ...
    @Autowired
    ServerProtectInterceptor serverProtectInterceptor;
    @Autowired

...
//
//    public final static String ATTRIBUTE_IGNORE_LOG_GLOBAL_FILTER = "@IgnoreAccessLogGlobalFilter";
//
...
//
//        if (exchange.getAttribute(ATTRIBUTE_IGNORE_LOG_GLOBAL_FILTER) != null) {
